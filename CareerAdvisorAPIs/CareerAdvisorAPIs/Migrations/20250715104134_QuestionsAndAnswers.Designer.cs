...
namespace CareerAdvisorAPIs.Migrations
{
    ...
    [Migration("20250715104134_QuestionsAndAnswers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareerAdvisorAPIs.Models.JobApplicationAnswer", b =>
                {
            ...
            modelBuilder.Entity("CareerAdvisorAPIs.Models.JobListingQuestion", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerAdvisorAPIs.Models.JobApplicationAnswer", b =>
                {
                    b.HasOne("CareerAdvisorAPIs.Models.JobApplication", "JobApplication")
                        .WithMany("JobApplicationAnswers")
                        .HasForeignKey("ApplicationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CareerAdvisorAPIs.Models.JobListingQuestion", "JobListingQuestion")
                        .WithMany()
                    ...
                    b.Navigation("JobListingQuestion");
                });
            ...
            modelBuilder.Entity("CareerAdvisorAPIs.Models.JobApplication", b =>
                {
                    b.Navigation("JobApplicationAnswers");
                });
            ...
            modelBuilder.Entity("CareerAdvisorAPIs.Models.JobListing", b =>
                {
                    ...
                    b.Navigation("JobListingQuestions");
